...
public class TempDb {
    public static List<User> getUsersFromTempDb() {
        return new ArrayList<User>() {
            {
                add(User.newBuilder().setId("U101").setName("Prithvi Sharma").setAge(23).setGender("MALE").setPhone(9096410286d)
                ...
                add(User.newBuilder().setId("U102").setName("John Doe").setAge(33).setGender("MALE").setPhone(92232954532d)
